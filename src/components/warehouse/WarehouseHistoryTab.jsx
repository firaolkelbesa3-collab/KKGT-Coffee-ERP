    ...
    <div className="flex gap-3 py-3 border-b border-border last:border-0">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-xs text-muted-foreground">
          {entry.coffee_code && <span className="font-mono font-medium text-[#126333]">{entry.coffee_code}</span>}
      ...
      <div className="flex flex-wrap items-center gap-2 mb-4">
        {QUICK.map(q => (
          <Button
            ...
            className={`text-xs h-7 ${quickLabel === q.label ? 'bg-[#126333] hover:bg-[#0e5229] text-white' : ''}`}
        ...
        <Button size="sm" className="h-7 gap-1.5" style={{ backgroundColor: '#126333' }} onClick={() => exportHistoryPDF(filtered)}>
