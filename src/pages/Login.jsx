...
export default function Login() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      // Supabase redirects to Google; control returns via the OAuth callback.
    } catch (err) {
  ...
  return (
    <AuthLayout
      icon={LogIn}
      title="Welcome to KKGT Coffee Flow"
      subtitle="Sign in with your Google account"
      footer={
        <span className="text-xs text-muted-foreground">
          Don&apos;t have access? Ask your administrator to invite you.
        </span>
      }
    >
      {error && (
