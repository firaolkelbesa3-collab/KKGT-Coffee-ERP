  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative bg-white w-full max-w-2xl h-full shadow-2xl flex flex-col overflow-hidden z-10">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b" style={{ backgroundColor: '#126433' }}>
          <div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          <Section title="A — Purchase Details">
            <Row label="Coffee Code" value={purchase.coffee_code || '—'} valueClass="text-[#126433] font-mono" />
